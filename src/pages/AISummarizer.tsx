...
const AISummarizer = () => {
  ...
  const handleSummarize = async () => {
    ...
    try {
      ...
      // Your backend route (correct one)
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <Card className="animate-slide-up border-2 hover:border-accent/50 transition-colors">
          ...
          <CardContent className="space-y-4">
            <div className="border-2 border-dashed rounded-lg p-8 text-center bg-muted/30 hover:border-accent/50">
            ...
            {error && (
              <div className="flex items-start gap-3 p-4 bg-destructive/10 rounded-lg border-2 border-destructive/50">
            ...
            {file && !error && (
              <div className="flex items-center gap-3 p-4 bg-accent/10 rounded-lg border-2 border-accent/50">
            ...
            <Button
              ...
              className="w-full h-12 text-lg gradient-accent shadow-lg"
            >
              {loading ? (
                <>
        ...
        <Card className="animate-slide-up border-2 hover:border-accent/50 transition-colors">
          <CardHeader>
            ...
            <CardDescription>AI-generated summary in simple language</CardDescription>
          </CardHeader>
            ...
            {summary ? (
              <div className="space-y-4 animate-fade-in">
                <div className="prose prose-sm max-w-none">
                  <div className="bg-muted/30 p-6 rounded-lg border-2 border-accent/20 whitespace-pre-wrap">
                    {summary}
                  </div>
                </div>
